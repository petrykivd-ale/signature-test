...
FLAMBOYANT_FEMININE_PROMPT = (
    "A highly stylized, flowing signature for the name {name}, written in dark blue ink from a top-down perspective. "
...
EVALUATION_PROMPT = (
    "Evaluate this signature image for the name {name}. Does it look professional, clear, and readable? "
